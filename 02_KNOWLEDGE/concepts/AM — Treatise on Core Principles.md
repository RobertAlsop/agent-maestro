---
title: "AM — Treatise on Core Principles"
type: concept
status: active
authority_weight: 55
schema_version: 3
...
**Purpose**: The extended derivation of Agent Maestro's foundational kernel. Where [[Agent Maestro — Foundations]] declares the kernel (3 seeds, 1 meta-principle, 3 laws), this document shows how it was discovered, why each element is necessary, and how all prior frameworks were reconciled into it.
