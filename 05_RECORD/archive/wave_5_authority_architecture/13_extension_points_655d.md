...
- Core rules in packs/operational_authority/05_rules]] are immutable via extension.
- Control gates in packs/operational_authority/06_control_gates]] require formal version change to modify.
